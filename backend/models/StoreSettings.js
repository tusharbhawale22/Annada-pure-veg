...
const storeSettingsSchema = new mongoose.Schema({
  ...
  tiffinPlans: {
    ...
    default: [
      { id: 'wl', name: 'Weekly Lunch',   planType: 'weekly',  mealType: 'lunch',  price: 350,  description: '7 fresh home-style lunches delivered daily',          numberOfDays: 7,  deliveryTime: '12:30 PM' },
      { id: 'wd', name: 'Weekly Dinner',  planType: 'weekly',  mealType: 'dinner', price: 350,  description: '7 nutritious dinners, freshly made every evening',      numberOfDays: 7,  deliveryTime: '6:00 PM' },
      { id: 'wb', name: 'Weekly Both',    planType: 'weekly',  mealType: 'both',   price: 650,  description: 'Lunch + Dinner for 7 days — best value!',               numberOfDays: 7,  deliveryTime: 'Lunch: 12:30 PM, Dinner: 6:00 PM' },
      { id: 'ml', name: 'Monthly Lunch',  planType: 'monthly', mealType: 'lunch',  price: 1300, description: '30 lunches — the most popular tiffin plan',             numberOfDays: 30, deliveryTime: '12:30 PM' },
      { id: 'md', name: 'Monthly Dinner', planType: 'monthly', mealType: 'dinner', price: 1300, description: '30 dinners delivered right to your door',               numberOfDays: 30, deliveryTime: '6:00 PM' },
      { id: 'mb', name: 'Monthly Both',   planType: 'monthly', mealType: 'both',   price: 2400, description: 'Lunch + Dinner for 30 days — ultimate convenience',     numberOfDays: 30, deliveryTime: 'Lunch: 12:30 PM, Dinner: 6:00 PM' },
    ],
  },
}, { timestamps: true });
